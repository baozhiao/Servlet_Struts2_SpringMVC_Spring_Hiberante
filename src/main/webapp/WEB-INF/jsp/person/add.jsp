							...
							<div class="widget-body am-fr">
								...
								<form class="am-form tpl-form-border-form tpl-form-border-br"
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input" name="person.pid"
												placeholder="请输入学号">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input"
												name="person.name" placeholder="请输入姓名">
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input"
												name="person.password" placeholder="请输入密码">
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input"
												name="person.cellphone" placeholder="请输入手机">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input"
												name="person.address" placeholder="请输入地址">
										</div>
									</div>
									...
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input"
												name="person.dorm" placeholder="请输入宿舍">
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input" name="person.job"
												placeholder="请输入职位">
										</div>
									</div>
									<div class="am-form-group">
										...
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input"
												name="person.remarks" placeholder="请输入备注">
										</div>
									</div>
									<div class="am-form-group">
										<label for="relationship" class="am-u-sm-3 am-form-label">联系人
											<span class="tpl-form-line-small-title">job</span>
										</label>
										<div class="am-u-sm-9">
											<input type="text" class="tpl-form-input"
												name="person.relationship" placeholder="请输入联系人">
										</div>
									</div>
									<div class="am-form-group">
